...
export function PortfolioSection() {
  const technicalCards = [
    ...
    },
    {
      ...
      description: "Plataforma proprietária AIKOM com múltiplos atendentes no mesmo número corporativo oficial, triagem automática com IA e histórico unificado do cliente.",
      chips: ["Plataforma Própria AIKOM", "WhatsApp Oficial", "Triagem com IA"],
